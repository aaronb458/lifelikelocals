        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-md">
              Experience authentic Bahamian culture with native guides who share
              down-home stories and traditional cuisine. We offer non-touristy
              alternatives to typical island tours.
            </p>
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-[#2ea3f2] transition-colors"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  className="text-white/70 hover:text-[#2ea3f2] transition-colors"
                >
                  Tours And Prices
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 text-[#2ea3f2] mt-1 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
